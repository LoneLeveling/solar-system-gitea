...
stage('Deploy - AWS EC2') {
    ...
    sh '''
        ssh -o StrictHostKeyChecking=no ubuntu@52.87.183.188 "
            ...
            sudo docker run --name solar-system -e MONGO_URI=$MONGO_URI -e MONGO_USERNAME=$MONGO_USERNAME -e MONGO_PASSWORD=$MONGO_PASSWORD -p 3000:3000 -d brawd375/solar-system:$GIT_COMMIT
        "
    '''
}
    }
